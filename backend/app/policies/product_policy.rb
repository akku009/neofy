class ProductPolicy < ApplicationPolicy
  # All product CRUD is restricted to the store owner.
  # TenantScoped already enforces store_id at the DB level;
  # this policy enforces ownership at the authorization layer.
